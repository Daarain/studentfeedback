...
class nmaform extends StatefulWidget {
  const nmaform({super.key});

  @override
  State<nmaform> createState() => _nmaform();
}
...
class _nmaform extends State<nmaform> {
  @override
  ...
  void writeCRtodb() {
    ...
    try {
      ...
      DatabaseReference dbref = FirebaseDatabase.instance
          ...
          .child('networkmanagementandadministration')
