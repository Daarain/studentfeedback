...
class dteform extends StatefulWidget {
  const dteform({super.key});

  @override
  State<dteform> createState() => _dteform();
}
...
class _dteform extends State<dteform> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.lightBlueAccent,
      appBar: AppBar(
        title: Text("Digital Techniques",
          style: TextStyle(
