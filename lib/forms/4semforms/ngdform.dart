...
class ngdform extends StatefulWidget {
  const ngdform({super.key});

  @override
  State<ngdform> createState() => _ngdform();
}
...
class _ngdform extends State<ngdform> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.lightBlueAccent,
      appBar: AppBar(
        title: Text("Next Generation Databases",
          style: TextStyle(
