...
class madform extends StatefulWidget {
  const madform({super.key});

  @override
  State<madform> createState() => _madform();
}
...
class _madform extends State<madform> {
  @override
  ...
  void writeCRtodb() {
    ...
    try {
      ...
      DatabaseReference dbref = FirebaseDatabase.instance
          ...
          .child('mobileapplicationdevelopment')
