...
class mvcform extends StatefulWidget {
  const mvcform({super.key});

  @override
  State<mvcform> createState() => _mvcform();
}
...
class _mvcform extends State<mvcform> {
  @override
  ...
  void writeCRtodb() {
    ...
    try {
      ...
      DatabaseReference dbref = FirebaseDatabase.instance
          ...
          .child('multimediaandvideocreation')
      ...
      DatabaseReference dbref2 = FirebaseDatabase.instance
          ...
          .child('greviances')
          .child('grevianceofsem1')
          .child('multimediaandvideocreation').child('courseoutcomesrelated')
          .child('cranswer2');
