...
class beeeform extends StatefulWidget {
  const beeeform({super.key});

  @override
  State<beeeform> createState() => _beeeform();
}
...
class _beeeform extends State<beeeform> {
  @override
  ...
  void writeCRtodb() {
    ...
    try {
      ...
      DatabaseReference dbref = FirebaseDatabase.instance
          ...
          .child('basicsofelectronicandelectricalengineering')
      ...
      DatabaseReference dbref2 = FirebaseDatabase.instance
          ...
          .child('greviances')
          .child('grevianceofsem1')
          .child('basicsofelectronicandelectricalengineering').child('courseoutcomesrelated')
          .child('cranswer2');
